...
namespace _Game_Interface_NavSystem_Blueprints_Widgets_Icons_Waypoint_W_IndicatorIcon_OpenDoor {
#pragma pack(push, 1)
struct W_IndicatorIcon_OpenDoor_C : public _Script_UMG::UserWidget {
