...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_SantaHat {
#pragma pack(push, 1)
struct ABP_SantaHat_C : public _Script_Engine::AnimInstance {
