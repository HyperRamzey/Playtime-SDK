...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_HatPonytail {
#pragma pack(push, 1)
struct ABP_HatPonytail_C : public _Script_Engine::AnimInstance {
