...
#pragma pack(push, 1)
struct RigUnit_TwoBoneIKSimplePerItem : public RigUnit_HighlevelBaseMutable {
    private: char pad_68[0x148]; public:
    void* get_ItemA();
    void* get_ItemB();
    void* get_EffectorItem();
    void* get_Effector();
    ...
    float& get_Weight();
    float& get_ItemALength();
    float& get_ItemBLength();
    bool get_bPropagateToChildren();
    void set_bPropagateToChildren(bool value);
    void* get_DebugSettings();
    void* get_CachedItemAIndex();
    void* get_CachedItemBIndex();
    void* get_CachedEffectorItemIndex();
