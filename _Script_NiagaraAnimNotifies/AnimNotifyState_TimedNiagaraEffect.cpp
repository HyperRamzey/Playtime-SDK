...
_Script_Engine::FXSystemComponent* _Script_NiagaraAnimNotifies::AnimNotifyState_TimedNiagaraEffect::GetSpawnedEffect(_Script_Engine::MeshComponent* MeshComp) {
    return;
}
