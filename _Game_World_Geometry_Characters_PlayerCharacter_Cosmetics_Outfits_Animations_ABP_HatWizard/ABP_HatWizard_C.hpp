...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_HatWizard {
#pragma pack(push, 1)
struct ABP_HatWizard_C : public _Script_Engine::AnimInstance {
