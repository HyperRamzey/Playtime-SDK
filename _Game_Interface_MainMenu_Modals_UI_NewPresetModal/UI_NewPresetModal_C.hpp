...
#pragma pack(push, 1)
struct UI_NewPresetModal_C : public _Script_UMG::UserWidget {
    ...
    _Game_Interface_Shoppy_Widgets_UI_StoreTooltipButton::UI_StoreTooltipButton_C*& get_SubmitButton();
    ...
    void BndEvt__UI_NewPresetModal_EditableTextBox_233_K2Node_ComponentBoundEvent_0_OnEditableTextBoxChangedEvent__DelegateSignature(void*& Text);
    void ExecuteUbergraph_UI_NewPresetModal(int32_t EntryPoint);
    void SubmitNewPreset__DelegateSignature(void* Name);
