...
struct HeadMountedDisplayFunctionLibrary : public _Script_Engine::BlueprintFunctionLibrary {
    ...
    _Script_CoreUObject::Vector2D GetPlayAreaBounds(void* Origin);
    ...
    void BreakKey(_Script_InputCore::Key InKey, void*& InteractionProfile, void*& Hand, void*& MotionSource, void*& Indentifier, void*& Component);
}; // Size: 0x28
#pragma pack(pop)
}
