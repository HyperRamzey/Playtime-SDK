...
_Script_CoreUObject::Vector2D _Script_HeadMountedDisplay::HeadMountedDisplayFunctionLibrary::GetPlayAreaBounds(void* Origin) {
    return;
}
...
void _Script_HeadMountedDisplay::HeadMountedDisplayFunctionLibrary::BreakKey(_Script_InputCore::Key InKey, void*& InteractionProfile, void*& Hand, void*& MotionSource, void*& Indentifier, void*& Component) {
    return;
}
