...
namespace _Game_Interface_NavSystem_Blueprints_Widgets_Icons_Waypoint_W_IndicatorIcon_PullDown {
#pragma pack(push, 1)
struct W_IndicatorIcon_PullDown_C : public _Script_UMG::UserWidget {
