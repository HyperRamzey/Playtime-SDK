...
void _Script_Niagara::NiagaraFunctionLibrary::SetTexture2DArrayObject(_Script_Niagara::NiagaraComponent* NiagaraSystem, void* OverrideName, _Script_Engine::Texture2DArray* Texture) {
    return;
}
