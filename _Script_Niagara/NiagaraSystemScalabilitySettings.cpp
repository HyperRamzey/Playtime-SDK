...
bool _Script_Niagara::NiagaraSystemScalabilitySettings::get_bCullByGlobalBudget() {
    return (*(uint8_t*)((uintptr_t)this + 0x30 + 0)) & 16 != 0;
}
void _Script_Niagara::NiagaraSystemScalabilitySettings::set_bCullByGlobalBudget(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x30 + 0);
...
float& _Script_Niagara::NiagaraSystemScalabilitySettings::get_MaxGlobalBudgetUsage() {
