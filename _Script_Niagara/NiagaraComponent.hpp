...
struct NiagaraComponent : public _Script_Engine::FXSystemComponent {
    private: char pad_450[0x1b0]; public:
    _Script_Niagara::NiagaraSystem*& get_Asset();
    void* get_TickBehavior();
    int32_t& get_RandomSeedOffset();
    ...
    void SetAsset(_Script_Niagara::NiagaraSystem* InAsset, bool bResetExistingOverrideParameters);
