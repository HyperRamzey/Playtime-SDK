...
bool _Script_Niagara::NiagaraFunctionSignature::get_bIsCompileTagGenerator() {
    return (*(uint8_t*)((uintptr_t)this + 0x31 + 0)) & 1 != 0;
}
void _Script_Niagara::NiagaraFunctionSignature::set_bIsCompileTagGenerator(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x31 + 0);
    *(uint8_t*)((uintptr_t)this + 0x31 + 0) = (cur_value & ~1) | (value ? 1 : 0);
}
bool _Script_Niagara::NiagaraFunctionSignature::get_bHidden() {
    return (*(uint8_t*)((uintptr_t)this + 0x31 + 0)) & 2 != 0;
}
void _Script_Niagara::NiagaraFunctionSignature::set_bHidden(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x31 + 0);
