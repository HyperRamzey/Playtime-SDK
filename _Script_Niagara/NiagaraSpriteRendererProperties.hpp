...
struct NiagaraSpriteRendererProperties : public NiagaraRendererProperties {
    private: char pad_78[0xa38]; public:
    ...
    void* get_PrevSpriteRotationBinding();
    void* get_PrevSpriteSizeBinding();
    void* get_PrevSpriteFacingBinding();
    void* get_PrevSpriteAlignmentBinding();
    void* get_PrevCameraOffsetBinding();
    void* get_PrevPivotOffsetBinding();
