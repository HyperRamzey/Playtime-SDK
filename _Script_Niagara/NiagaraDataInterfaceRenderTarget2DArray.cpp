...
void _Script_Niagara::NiagaraDataInterfaceRenderTarget2DArray::set_bOverrideFormat(bool value) {
    ...
    *(uint8_t*)((uintptr_t)this + 0xe5 + 0) = (cur_value & ~2) | (value ? 2 : 0);
}
...
bool _Script_Niagara::NiagaraDataInterfaceRenderTarget2DArray::get_bInheritUserParameterSettings() {
    return (*(uint8_t*)((uintptr_t)this + 0xe5 + 0)) & 1 != 0;
}
void _Script_Niagara::NiagaraDataInterfaceRenderTarget2DArray::set_bInheritUserParameterSettings(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0xe5 + 0);
...
bool _Script_Niagara::NiagaraDataInterfaceRenderTarget2DArray::get_bOverrideFormat() {
    return (*(uint8_t*)((uintptr_t)this + 0xe5 + 0)) & 2 != 0;
}
