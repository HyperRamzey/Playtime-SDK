...
bool _Script_Niagara::NiagaraSystem::get_bNeedsGPUContextInitForDataInterfaces() {
    return (*(uint8_t*)((uintptr_t)this + 0x3b5 + 0)) & 1 != 0;
}
void _Script_Niagara::NiagaraSystem::set_bNeedsGPUContextInitForDataInterfaces(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x3b5 + 0);
    *(uint8_t*)((uintptr_t)this + 0x3b5 + 0) = (cur_value & ~1) | (value ? 1 : 0);
}
