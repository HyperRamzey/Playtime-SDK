...
bool _Script_Niagara::NiagaraSystemScalabilityOverride::get_bOverrideGlobalBudgetCullingSettings() {
    return (*(uint8_t*)((uintptr_t)this + 0x48 + 0)) & 16 != 0;
}
void _Script_Niagara::NiagaraSystemScalabilityOverride::set_bOverrideGlobalBudgetCullingSettings(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x48 + 0);
