...
void* _Script_Niagara::NiagaraVMExecutableData::get_CompileTags() {
...
bool _Script_Niagara::NiagaraVMExecutableData::get_bNeedsGPUContextInit() {
    return (*(uint8_t*)((uintptr_t)this + 0xe8 + 0)) & 2 != 0;
}
void _Script_Niagara::NiagaraVMExecutableData::set_bNeedsGPUContextInit(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0xe8 + 0);
