...
bool _Script_Niagara::NiagaraDataInterfaceRenderTargetVolume::get_bInheritUserParameterSettings() {
...
void _Script_Niagara::NiagaraDataInterfaceRenderTargetVolume::set_bInheritUserParameterSettings(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0xe5 + 0);
