...
namespace _Game_Interface_NavSystem_Blueprints_Widgets_Icons_Default_W_IndicatorIcon_HuggyScream {
#pragma pack(push, 1)
struct W_IndicatorIcon_HuggyScream_C : public _Script_UMG::UserWidget {
