...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_HatJester {
#pragma pack(push, 1)
struct ABP_HatJester_C : public _Script_Engine::AnimInstance {
