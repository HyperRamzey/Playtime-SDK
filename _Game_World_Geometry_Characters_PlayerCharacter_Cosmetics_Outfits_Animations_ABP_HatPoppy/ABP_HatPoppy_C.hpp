...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_HatPoppy {
#pragma pack(push, 1)
struct ABP_HatPoppy_C : public _Script_Engine::AnimInstance {
    ...
    void ExecuteUbergraph_ABP_HatPoppy(int32_t EntryPoint);
}; // Size: 0xd50
#pragma pack(pop)
}
