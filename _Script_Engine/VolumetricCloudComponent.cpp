...
float& _Script_Engine::VolumetricCloudComponent::get_StopTracingTransmittanceThreshold() {
...
void _Script_Engine::VolumetricCloudComponent::SetStopTracingTransmittanceThreshold(float NewValue) {
    return;
}
