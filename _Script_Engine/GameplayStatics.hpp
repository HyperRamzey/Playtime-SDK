...
struct GameplayStatics : public BlueprintFunctionLibrary {
    ...
    void UnRetainAllSoundsInSoundClass(_Script_Engine::SoundClass* InSoundClass);
    ...
    void PrimeAllSoundsInSoundClass(_Script_Engine::SoundClass* InSoundClass);
    ...
    _Script_Engine::Actor* FindNearestActor(_Script_CoreUObject::Vector Origin, void*& ActorsToCheck, float& Distance);
