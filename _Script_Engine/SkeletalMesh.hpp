...
struct SkeletalMesh : public StreamableRenderAsset {
    private: char pad_60[0x340]; public:
    ...
    bool get_bSupportRayTracing();
    void set_bSupportRayTracing(bool value);
    ...
    void SetMorphTargets(void*& InMorphTargets);
    void SetMeshClothingAssets(void*& InMeshClothingAssets);
    void SetMaterials(void*& InMaterials);
    ...
    _Script_Engine::Skeleton* GetSkeleton();
    _Script_Engine::PhysicsAsset* GetShadowPhysicsAsset();
    _Script_Engine::PhysicsAsset* GetPhysicsAsset();
    void* GetNodeMappingData();
    _Script_Engine::NodeMappingContainer* GetNodeMappingContainer(_Script_Engine::Blueprint* SourceAsset);
    void* GetMorphTargets();
    void* GetMeshClothingAssets();
    void* GetMaterials();
    _Script_Engine::SkeletalMeshLODSettings* GetLODSettings();
