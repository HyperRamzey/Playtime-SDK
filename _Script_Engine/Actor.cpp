...
bool _Script_Engine::Actor::get_bForceNetAddressable() {
    return (*(uint8_t*)((uintptr_t)this + 0x58 + 0)) & 128 != 0;
}
void _Script_Engine::Actor::set_bForceNetAddressable(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x58 + 0);
...
bool _Script_Engine::Actor::get_bAllowReceiveTickEventOnDedicatedServer() {
    return (*(uint8_t*)((uintptr_t)this + 0x5b + 0)) & 8 != 0;
}
void _Script_Engine::Actor::set_bAllowReceiveTickEventOnDedicatedServer(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x5b + 0);
    *(uint8_t*)((uintptr_t)this + 0x5b + 0) = (cur_value & ~8) | (value ? 8 : 0);
}
...
float _Script_Engine::Actor::GetSquaredHorizontalDistanceTo(_Script_Engine::Actor* OtherActor) {
    return;
}
