...
bool _Script_Engine::PostProcessSettings::get_bOverride_TemperatureType() {
...
void _Script_Engine::PostProcessSettings::set_bOverride_TemperatureType(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x0 + 0);
...
void _Script_Engine::PostProcessSettings::set_PathTracingEnableDenoiser(bool value) {
...
void _Script_Engine::PostProcessSettings::set_bOverride_PathTracingMaxPathExposure(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x1e + 0);
    *(uint8_t*)((uintptr_t)this + 0x1e + 0) = (cur_value & ~8) | (value ? 8 : 0);
}
...
bool _Script_Engine::PostProcessSettings::get_bOverride_PathTracingEnableEmissive() {
    return (*(uint8_t*)((uintptr_t)this + 0x1e + 0)) & 4 != 0;
}
...
void _Script_Engine::PostProcessSettings::set_PathTracingEnableEmissive(bool value) {
...
float& _Script_Engine::PostProcessSettings::get_PathTracingFilterWidth() {
...
bool _Script_Engine::PostProcessSettings::get_bOverride_PathTracingFilterWidth() {
...
void _Script_Engine::PostProcessSettings::set_bOverride_PathTracingFilterWidth(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x1e + 0);
...
void _Script_Engine::PostProcessSettings::set_bOverride_PathTracingEnableEmissive(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x1e + 0);
    *(uint8_t*)((uintptr_t)this + 0x1e + 0) = (cur_value & ~4) | (value ? 4 : 0);
}
float& _Script_Engine::PostProcessSettings::get_Bloom2Size() {
    return *(float*)((uintptr_t)this + 0x22c);
}
bool _Script_Engine::PostProcessSettings::get_bOverride_PathTracingMaxPathExposure() {
    return (*(uint8_t*)((uintptr_t)this + 0x1e + 0)) & 8 != 0;
}
bool _Script_Engine::PostProcessSettings::get_bOverride_PathTracingEnableDenoiser() {
    return (*(uint8_t*)((uintptr_t)this + 0x1e + 0)) & 16 != 0;
}
void _Script_Engine::PostProcessSettings::set_bOverride_PathTracingEnableDenoiser(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x1e + 0);
    *(uint8_t*)((uintptr_t)this + 0x1e + 0) = (cur_value & ~16) | (value ? 16 : 0);
}
...
void* _Script_Engine::PostProcessSettings::get_TemperatureType() {
...
bool _Script_Engine::PostProcessSettings::get_PathTracingEnableEmissive() {
    return (*(uint8_t*)((uintptr_t)this + 0x534 + 0)) & 1 != 0;
}
float& _Script_Engine::PostProcessSettings::get_PathTracingMaxPathExposure() {
    return *(float*)((uintptr_t)this + 0x538);
}
bool _Script_Engine::PostProcessSettings::get_PathTracingEnableDenoiser() {
