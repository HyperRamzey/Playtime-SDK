...
void _Script_Engine::Material::set_bNormalCurvatureToRoughness(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x208 + 0);
    *(uint8_t*)((uintptr_t)this + 0x208 + 0) = (cur_value & ~8) | (value ? 8 : 0);
}
...
bool _Script_Engine::Material::get_bForwardBlendsSkyLightCubemaps() {
...
void _Script_Engine::Material::set_bForwardBlendsSkyLightCubemaps(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x208 + 0);
...
bool _Script_Engine::Material::get_bNormalCurvatureToRoughness() {
    return (*(uint8_t*)((uintptr_t)this + 0x208 + 0)) & 8 != 0;
}
...
bool _Script_Engine::Material::get_WriteDepthToTranslucentMaterial() {
    return (*(uint8_t*)((uintptr_t)this + 0x20a + 0)) & 16 != 0;
}
void _Script_Engine::Material::set_WriteDepthToTranslucentMaterial(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x20a + 0);
    *(uint8_t*)((uintptr_t)this + 0x20a + 0) = (cur_value & ~16) | (value ? 16 : 0);
}
