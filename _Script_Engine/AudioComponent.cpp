...
void _Script_Engine::AudioComponent::SetOutputToBusOnly(bool bInOutputToBusOnly) {
    return;
}
...
void _Script_Engine::AudioComponent::SetAudioBusSendPostEffect(_Script_Engine::AudioBus* AudioBus, float AudioBusSendLevel) {
    return;
}
