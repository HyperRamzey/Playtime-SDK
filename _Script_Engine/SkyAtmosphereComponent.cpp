...
void _Script_Engine::SkyAtmosphereComponent::SetMultiScatteringFactor(float NewValue) {
    return;
}
...
void _Script_Engine::SkyAtmosphereComponent::SetAtmosphereHeight(float NewValue) {
    return;
}
void _Script_Engine::SkyAtmosphereComponent::SetAerialPespectiveViewDistanceScale(float NewValue) {
    return;
}
_Script_CoreUObject::LinearColor _Script_Engine::SkyAtmosphereComponent::GetAtmosphereTransmitanceOnGroundAtPlanetTop(_Script_Engine::DirectionalLightComponent* DirectionalLight) {
    return;
}
