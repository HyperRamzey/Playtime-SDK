...
void* _Script_Engine::StaticMesh::GetStaticMaterials() {
    return;
}
...
bool _Script_Engine::StaticMesh::get_bSupportRayTracing() {
    return (*(uint8_t*)((uintptr_t)this + 0xb4 + 0)) & 32 != 0;
}
void _Script_Engine::StaticMesh::set_bSupportRayTracing(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0xb4 + 0);
...
void _Script_Engine::StaticMesh::SetStaticMaterials(void*& InStaticMaterials) {
    return;
}
