...
struct PrimitiveComponent : public SceneComponent {
    private: char pad_200[0x250]; public:
    ...
    bool get_bVisibleInSceneCaptureOnly();
    void set_bVisibleInSceneCaptureOnly(bool value);
    bool get_bHiddenInSceneCapture();
    void set_bHiddenInSceneCapture(bool value);
    ...
    float& get_TranslucencySortDistanceOffset();
