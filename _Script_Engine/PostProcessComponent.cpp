...
void _Script_Engine::PostProcessComponent::set_bUnbound(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x76c + 0);
    *(uint8_t*)((uintptr_t)this + 0x76c + 0) = (cur_value & ~2) | (value ? 2 : 0);
}
...
bool _Script_Engine::PostProcessComponent::get_bEnabled() {
    return (*(uint8_t*)((uintptr_t)this + 0x76c + 0)) & 1 != 0;
}
...
void _Script_Engine::PostProcessComponent::set_bEnabled(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x76c + 0);
    *(uint8_t*)((uintptr_t)this + 0x76c + 0) = (cur_value & ~1) | (value ? 1 : 0);
}
...
bool _Script_Engine::PostProcessComponent::get_bUnbound() {
    return (*(uint8_t*)((uintptr_t)this + 0x76c + 0)) & 2 != 0;
}
