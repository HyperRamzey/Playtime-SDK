...
#include "PhysicsFieldComponent.hpp"
...
_Script_Engine::WorldComposition*& _Script_Engine::World::get_WorldComposition() {
    return *(_Script_Engine::WorldComposition**)((uintptr_t)this + 0x5e0);
}
...
_Script_Engine::PhysicsFieldComponent*& _Script_Engine::World::get_PhysicsField() {
    return *(_Script_Engine::PhysicsFieldComponent**)((uintptr_t)this + 0x1f8);
}
