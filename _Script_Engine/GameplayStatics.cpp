...
void _Script_Engine::GameplayStatics::UnRetainAllSoundsInSoundClass(_Script_Engine::SoundClass* InSoundClass) {
    return;
}
...
void _Script_Engine::GameplayStatics::PrimeAllSoundsInSoundClass(_Script_Engine::SoundClass* InSoundClass) {
    return;
}
...
void _Script_Engine::GameplayStatics::GetAccurateRealTime(int32_t& Seconds, float& PartialSeconds) {
    return;
}
...
_Script_Engine::Actor* _Script_Engine::GameplayStatics::FindNearestActor(_Script_CoreUObject::Vector Origin, void*& ActorsToCheck, float& Distance) {
    return;
}
