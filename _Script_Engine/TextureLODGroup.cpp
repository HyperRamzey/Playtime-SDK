...
void* _Script_Engine::TextureLODGroup::get_LossyCompressionAmount() {
...
bool _Script_Engine::TextureLODGroup::get_HighPriorityLoad() {
    return (*(uint8_t*)((uintptr_t)this + 0x51 + 0)) & 1 != 0;
}
void _Script_Engine::TextureLODGroup::set_HighPriorityLoad(bool value) {
