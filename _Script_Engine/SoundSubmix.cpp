...
void* _Script_Engine::SoundSubmix::get_OutputVolumeModulation() {
    return (void*)((uintptr_t)this + 0x78);
}
void* _Script_Engine::SoundSubmix::get_WetLevelModulation() {
    return (void*)((uintptr_t)this + 0x88);
}
void* _Script_Engine::SoundSubmix::get_DryLevelModulation() {
