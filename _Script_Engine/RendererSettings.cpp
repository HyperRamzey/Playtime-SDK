...
void* _Script_Engine::RendererSettings::get_MaxSkinBones() {
...
bool _Script_Engine::RendererSettings::get_bVirtualTextureEnableAutoImport() {
...
void _Script_Engine::RendererSettings::set_bVirtualTextureEnableAutoImport(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x54 + 0);
...
bool _Script_Engine::RendererSettings::get_bMobileSupportsGen4TAA() {
...
void* _Script_Engine::RendererSettings::get_HMDFixedFoveationLevel() {
...
void _Script_Engine::RendererSettings::set_bMobileSupportsGen4TAA(bool value) {
