...
void _Script_Engine::InterpToMovementComponent::AddControlPointPosition(_Script_CoreUObject::Vector Pos, bool bPositionIsRelative) {
    return;
}
...
void _Script_Engine::InterpToMovementComponent::ResetControlPoints() {
    return;
}
