...
struct Material : public MaterialInterface {
    private: char pad_88[0x3b8]; public:
    ...
    bool get_bForwardBlendsSkyLightCubemaps();
    void set_bForwardBlendsSkyLightCubemaps(bool value);
    ...
    bool get_WriteDepthToTranslucentMaterial();
    void set_WriteDepthToTranslucentMaterial(bool value);
