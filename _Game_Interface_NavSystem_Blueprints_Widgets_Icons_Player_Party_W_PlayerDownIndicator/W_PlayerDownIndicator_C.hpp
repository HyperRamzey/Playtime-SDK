...
namespace _Game_Interface_NavSystem_Blueprints_Widgets_Icons_Player_Party_W_PlayerDownIndicator {
#pragma pack(push, 1)
struct W_PlayerDownIndicator_C : public _Script_UMG::UserWidget {
    ...
    _Script_UMG::Image*& get_Image_165();
