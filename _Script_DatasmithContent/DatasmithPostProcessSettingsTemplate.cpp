...
bool _Script_DatasmithContent::DatasmithPostProcessSettingsTemplate::get_bOverride_CameraShutterSpeed() {
    return (*(uint8_t*)((uintptr_t)this + 0x0 + 0)) & 64 != 0;
}
void _Script_DatasmithContent::DatasmithPostProcessSettingsTemplate::set_bOverride_CameraShutterSpeed(bool value) {
    const auto cur_value = *(uint8_t*)((uintptr_t)this + 0x0 + 0);
    *(uint8_t*)((uintptr_t)this + 0x0 + 0) = (cur_value & ~64) | (value ? 64 : 0);
}
bool _Script_DatasmithContent::DatasmithPostProcessSettingsTemplate::get_bOverride_DepthOfFieldFstop() {
    return (*(uint8_t*)((uintptr_t)this + 0x4 + 0)) & 1 != 0;
}
void _Script_DatasmithContent::DatasmithPostProcessSettingsTemplate::set_bOverride_DepthOfFieldFstop(bool value) {
...
float& _Script_DatasmithContent::DatasmithPostProcessSettingsTemplate::get_CameraShutterSpeed() {
    return *(float*)((uintptr_t)this + 0x38);
}
float& _Script_DatasmithContent::DatasmithPostProcessSettingsTemplate::get_DepthOfFieldFstop() {
