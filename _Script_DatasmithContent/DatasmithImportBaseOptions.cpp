...
bool _Script_DatasmithContent::DatasmithImportBaseOptions::get_bIncludeAnimation() {
    return (*(uint8_t*)((uintptr_t)this + 0x5 + 0)) & 1 != 0;
}
void _Script_DatasmithContent::DatasmithImportBaseOptions::set_bIncludeAnimation(bool value) {
