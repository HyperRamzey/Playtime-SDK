...
void _Script_OnlineSubsystemUtils::PartyBeaconClient::ServerAddOrUpdateReservationRequest(void* SessionID, _Script_OnlineSubsystemUtils::PartyReservation& Reservation) {
    return;
}
