...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Grabpacks_Animations_ABP_GrabpackHuggy {
#pragma pack(push, 1)
struct ABP_GrabpackHuggy_C : public _Script_Engine::AnimInstance {
