...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_OutfitCat {
#pragma pack(push, 1)
struct ABP_OutfitCat_C : public _Script_Engine::AnimInstance {
