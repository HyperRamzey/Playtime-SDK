...
struct UI_PlayAsButton_C : public _Script_UMG::UserWidget {
    ...
    void BndEvt__UI_PlayAsButton_Button_491_K2Node_ComponentBoundEvent_0_OnButtonReleasedEvent__DelegateSignature();
    void BndEvt__UI_PlayAsButton_PlayButton_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature();
    void BndEvt__UI_PlayAsButton_PlayButton_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature();
    void ExecuteUbergraph_UI_PlayAsButton(int32_t EntryPoint);
