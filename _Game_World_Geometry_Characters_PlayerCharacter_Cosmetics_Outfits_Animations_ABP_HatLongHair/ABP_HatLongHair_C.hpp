...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Outfits_Animations_ABP_HatLongHair {
#pragma pack(push, 1)
struct ABP_HatLongHair_C : public _Script_Engine::AnimInstance {
    ...
    void ExecuteUbergraph_ABP_HatLongHair(int32_t EntryPoint);
}; // Size: 0xd50
#pragma pack(pop)
}
