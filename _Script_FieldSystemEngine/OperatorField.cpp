...
_Script_FieldSystemEngine::OperatorField* _Script_FieldSystemEngine::OperatorField::SetOperatorField(float Magnitude, _Script_FieldSystemEngine::FieldNodeBase* LeftField, _Script_FieldSystemEngine::FieldNodeBase* RightField, void* Operation) {
    return;
}
