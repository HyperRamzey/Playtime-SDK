...
struct OperatorField : public FieldNodeBase {
    ...
    _Script_FieldSystemEngine::OperatorField* SetOperatorField(float Magnitude, _Script_FieldSystemEngine::FieldNodeBase* LeftField, _Script_FieldSystemEngine::FieldNodeBase* RightField, void* Operation);
}; // Size: 0xd0
#pragma pack(pop)
}
