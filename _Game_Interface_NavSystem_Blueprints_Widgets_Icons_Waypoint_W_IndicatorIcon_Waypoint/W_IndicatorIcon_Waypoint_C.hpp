...
namespace _Game_Interface_NavSystem_Blueprints_Widgets_Icons_Waypoint_W_IndicatorIcon_Waypoint {
#pragma pack(push, 1)
struct W_IndicatorIcon_Waypoint_C : public _Script_UMG::UserWidget {
    private: char pad_260[0x58]; public:
    void* get_UberGraphFrame();
    _Script_UMG::WidgetAnimation*& get_SAnim();
