...
namespace _Game_World_Geometry_Characters_PlayerCharacter_Cosmetics_Grabpacks_Animations_ABP_GrabpackPirate {
#pragma pack(push, 1)
struct ABP_GrabpackPirate_C : public _Script_Engine::AnimInstance {
    ...
    void ExecuteUbergraph_ABP_GrabpackPirate(int32_t EntryPoint);
}; // Size: 0xd50
#pragma pack(pop)
}
